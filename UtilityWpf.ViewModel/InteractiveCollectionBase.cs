...
namespace UtilityWpf.ViewModel
{
    ...
    public abstract class InteractiveCollectionBase<T> : NPC
    {
        ...
        public IObservable<KeyValuePair<IContainer<T>, ChangeReason>> Changes => changes;
        ISubject<KeyValuePair<IContainer<T>, ChangeReason>> changes = new Subject<KeyValuePair<IContainer<T>, ChangeReason>>();
        ...
        public ReactiveCollection<object> @unchecked { get; } = new ReactiveCollection<object>();
            ...
            so.WhenPropertyChanged(_ => _.IsExpanded).Select(_ => _.Value).Subscribe(_ =>
             {
                 ...
                 ((ISubject<KeyValuePair<IContainer<T>, ChangeReason>>)col.Changes).OnNext(new KeyValuePair<IContainer<T>, ChangeReason>(so, ChangeReason.Update));
             });
